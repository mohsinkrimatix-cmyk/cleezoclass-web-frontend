...
useEffect(() => {
  ...
  const fetchChatSummary = async () => {
    try {
      const res = await axios.get("https://cleezoclass.com:5000/api/api/chat-summary", {
        params: { schoolCode },
      });
  ...
  const fetchTotalEvents = async () => {
    try {
      const res = await axios.get("https://cleezoclass.com:5000/api/api/event-summary", {
        params: { schoolCode },
      });
  ...
  const fetchPendingEventsCount = async () => {
    try {
      const res = await axios.get(
        "https://cleezoclass.com:5000/api/api/pending-events-count",
        {
          params: { schoolCode },
        }
      );
  ...
  const fetchUpcomingEvents = async () => {
    ...
    try {
      const res = await axios.get("https://cleezoclass.com:5000/api/api/upcoming-events", {
        params: { schoolCode },
      });
  ...
  const fetchCompletedEvents = async () => {
    ...
    try {
      const res = await axios.get("https://cleezoclass.com:5000/api/api/completed-events", {
        params: { schoolCode },
      });
  ...
  const fetchIrregulars = async () => {
    try {
      const res = await axios.get("https://cleezoclass.com:5000/teacher-list-of-irregulars", {
        params: { schoolCode },
      });
      setRecords(res.data);
    } catch (err) {
  ...
  const fetchAdmissions = async () => {
    try {
      const response = await axios.get("https://cleezoclass.com:5000/newadmissions", {
        params: { schoolCode },
      });
  ...
  const fetchAllTeachers = async () => {
    ...
    try {
      const response = await axios.post("https://cleezoclass.com:5000/api/users", {
        schoolCode,
        user_type: "teacher",
      });
  ...
  const handleView1 = async (type) => {
    ...
    if (type === "Total Chats") {
      url = `https://cleezoclass.com:5000/api/api/chat-requests/all?schoolCode=${schoolCode}`;
    } else if (type === "Accepted Chats") {
      url = `https://cleezoclass.com:5000/api/api/chat-requests/approved?schoolCode=${schoolCode}`;
    } else if (type === "Pending Chat Requests") {
      url = `https://cleezoclass.com:5000/api/api/chat-requests/pending?schoolCode=${schoolCode}`;
    }
...
const handleApprove = async (id) => {
  try {
    ...
    await axios.put(
      `https://cleezoclass.com:5000/api/chat-requests/approve/${id}?schoolCode=${schoolCode}`
    );

setPopupMessage("Request approved!");

    const res = await axios.get(
      `https://cleezoclass.com:5000/api/chat-requests/pending?schoolCode=${schoolCode}`
    );
...
const handleReject = async (id) => {
  try {
    ...
    await axios.put(
      `https://cleezoclass.com:5000/api/chat-requests/reject/${id}?schoolCode=${schoolCode}`
    );
