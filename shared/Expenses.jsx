...
export default function ExpenseChief() {
    ...
    const fetchAndCalculateSalaryTotals = async (monthYear) => {
        ...
        try {
            ...
            const response = await axios.get(`https://cleezoclass.com:5000/api/salaryLedger?schoolCode=${schoolCode}&year=${year}&month=${month}`);
            const data = response.data || [];
    ...
    const fetchAndCalculateUtilitiesTotals = async (monthYear) => {
        ...
        try {
            ...
            const response = await axios.get(`https://cleezoclass.com:5000/api/utilitiesexpenses?schoolCode=${schoolCode}&year=${year}&month=${month}`);
            const data = response.data || [];
    ...
    const fetchChartData = async () => { 
        ...
        try {
            const expensesPromise = axios.get(`https://cleezoclass.com:5000/api/totalexpenses?schoolCode=${schoolCode}`);
