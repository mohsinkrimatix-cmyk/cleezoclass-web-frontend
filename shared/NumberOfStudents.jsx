...
function NumberOfStudents() {
    ...
    //                 "https://cleezoclass.com:5000/api/current-students"
    //             );
    ...
    //     const fetchStudents = async () => {
    //         try {
    //             const response = await fetch("https://cleezoclass.com:5000/api/active-students");
    ...
    const fetchData = async () => {
        try {
            const [allStudentsResponse, activeStudentsResponse] = await Promise.all([
                fetch("https://cleezoclass.com:5000/api/current-students"),
                fetch("https://cleezoclass.com:5000/api/active-students"),
            ]);
