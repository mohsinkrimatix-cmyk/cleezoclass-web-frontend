...
useEffect(() => {
  ...
  axios.get(`https://cleezoclass.com:5000/rooms?schoolCode=${schoolCode}`)
...
const handleSetRooms = async () => {
  try {
    ...
    await axios.post("https://cleezoclass.com:5000/rooms", {
      roomsUpTo: parseInt(roomsUpTo),
      benches: parseInt(benchesPerRoom),
      schoolCode
    });
    await axios.post("https://cleezoclass.com:5000/classes", {
...
const handleShowRooms = async () => {
  try {
    const roomsRes = await axios.get(`https://cleezoclass.com:5000/rooms?schoolCode=${schoolCode}`);
