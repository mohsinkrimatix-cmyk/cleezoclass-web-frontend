...
const Dashboard = ({ schoolCode }) => {
  ...
  const [statusError, setStatusError] = useState('');
    ...
    const handleRequestSubmit = async (e) => {
        ...
        try {
            const schoolCode = localStorage.getItem('schoolCode');
            const response = await axios.post('https://cleezoclass.com:5000/api/expense-request', {
                ...requestFormData,
...
const [personTotals, setPersonTotals] = useState({});
  ...
  const handleExpenseType = async () => {
    const schoolCode = localStorage.getItem("schoolCode");
    try {
      const res = await fetch("https://cleezoclass.com:5000/api/getExpenseData", {
        method: "POST",
...
const fetchDataBasedOnClassAndSection = async (className, section) => {
  try {
    const res = await fetch("https://cleezoclass.com:5000/api/getFeesDataOfStudents", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        schoolCode,
...
const getCompleteFeeBasedOnClass = async (classNames) => {
  try {
    const response = await axios.post(`https://cleezoclass.com:5000/api/getClassFeeDetailsledger`, {
      schoolCode,
      classNames
    });
    ...
    useEffect(() => {
        ...
        const fetchClassData = async () => {
            ...
            try {
                ...
                const response = await axios.get(`https://cleezoclass.com:5000/api/studentsName/${formattedClassName}`, {
                    params: { schoolCode },
                });
...
const handleRowClick = async (student) => {
    ...
    try {
        const response = await axios.get(`https://cleezoclass.com:5000/api/student-fee-details`, {
            params: {
                schoolCode: schoolCode,
        ...
        try {
            const busFeeRes = await axios.post("https://cleezoclass.com:5000/get-bus-fee", {
  ...
  useEffect(() => {
    const fetchStudentCount = async () => {
      try {
        ...
        const response = await fetch(`https://cleezoclass.com:5000/api/students/count?schoolCode=${encodeURIComponent(schoolCode)}`);
...
useEffect(() => {
  const fetchTeacherCount = async () => {
    try {
      ...
      const response = await fetch(`https://cleezoclass.com:5000/api/teacher/count?schoolCode=${encodeURIComponent(schoolCode)}`);
  ...
  const fetchDataForLedger = async (className, section) => {
    try {
      ...
      const res = await fetch("https://cleezoclass.com:5000/getFeesDataOfStudents", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          schoolCode,
...
const fetchTotals = async (schoolCode) => {
    ...
    const fetchIncome = async (schoolCode) => {
        ...
        try {
            const response = await axios.get('https://cleezoclass.com:5000/api/otherincome/totalsincome', {
                params: {
                    schoolCode: schoolCode
                }
            });
...
const handleSearch = async () => {
  ...
  try {
    ...
    const expensesPromise = axios.get(`https://cleezoclass.com:5000/api/totalexpensesData?schoolCode=${schoolCode}`);
...
const [originalUserExpensesData, setOriginalUserExpensesData] = useState(null);
 ...
 const fetchExpensesData = async (dateRange) => {
    const schoolCode = localStorage.getItem("schoolCode")
    // const schoolCode = localStorage.getItem("schoolCode")
    // let url = "https://cleezoclass.com:5000/api/totalexpenses"; 
     let url = "https://cleezoclass.com:5000/api/totalexpensesData";
