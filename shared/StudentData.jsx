...
const StudentData = () => {
    ...
    const fetchClasses = async () => {
      ...
      try {
        const response = await axios.get(
          `https://cleezoclass.com:5000/api/classesselectedstudents`,
          { params: { schoolCode } }
        );
  ...
  useEffect(() => {
    ...
    const fetchSections = async () => {
      ...
      try {
        const response = await axios.get(
          `https://cleezoclass.com:5000/api/sections/${selectedClass}`,
          { params: { schoolCode } }
        );
        if (Array.isArray(response.data)) {
    ...
    const fetchStudentData = async () => {
      ...
      try {
        ...
        const response = await fetch(
          "https://cleezoclass.com:5000/api/studentsData",
          {
            method: "GET",
            headers: {
  ...
  useEffect(() => {
    ...
    const fetchStudents = async () => {
      ...
      try {
        const response = await axios.get(
          `https://cleezoclass.com:5000/api/users/${selectedClass}`,
          {
            params: {
              user_type: 'student',
              schoolCode,
