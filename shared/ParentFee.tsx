  ...
  useEffect(() => {
    ...
    const fetchFees = async () => {
      try {
        ...
        const classFeeUrl = `https://cleezoclass.com:5000/feeStructure/${encodeURIComponent(
        ...
        const [classRes, studentRes] = await Promise.allSettled([
          ...
          axios.post('https://cleezoclass.com:5000/api/studentFees', {
    ...
    const fetchPaymentDetails = async () => {
      try {
        ...
        const paymentApiUrl = `https://cleezoclass.com:5000/api/payment/${studentData.studentId}?schoolCode=${studentData.schoolCode}`;
