...
const ParentAdmissionPage = () => {
  ...
  const calculateAndSubmit = async () => {
    ...
    try {
      const response = await fetch(`https://cleezoclass.com:5000/api/leads/update-score`, {
        method: 'POST',
...
const regNoFromStorage = parentData?.reg_no;
  ...
  useEffect(() => {
    ...
    fetch(`https://cleezoclass.com:5000/api/communication/leads?schoolCode=${schoolCode}`)
      .then((res) => res.json())
      .then((data) => {
...
const regNoFromStorage = parentData?.reg_no;
  ...
  useEffect(() => {
    ...
    const url = `https://cleezoclass.com:5000/api/communication/leads?schoolCode=${schoolCode}`;
