...
const ChatOperations = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        const response = await axios.get('https://cleezoclass.com:5000/api/events', {
          params: { schoolCode },
        });
  ...
  const fetchHolidays = () => {
    const schoolCode = localStorage.getItem('schoolCode');
    axios.get('https://cleezoclass.com:5000/api/holidays', { params: { schoolCode } })
...
const handleSubmitComplaint = async () => {
  ...
  try {
    await axios.post(
      "https://cleezoclass.com:5000/api/chat_requests/create",
      {
        schoolCode,
...
const handleSendHoliday = () => {
  ...
  axios.post('https://cleezoclass.com:5000/api/holidays', { date: holidayDate, name: holidayName, schoolCode })
    .then(res => {
      setPopup({
...
const handleDeleteHoliday = () => {
  ...
  axios.delete(`https://cleezoclass.com:5000/api/holidays/${selectedHoliday}`, { params: { schoolCode } })
    .then(() => {
      setPopup({
...
const handleDeleteFestival = (eventId) => {
  ...
  // Example: axios.delete(`https://cleezoclass.com:5000/api/events/${selectedEvent.id}`, { params: { schoolCode: localStorage.getItem('schoolCode') } })
...
useEffect(() => {
  ...
  axios
    .get(`https://cleezoclass.com:5000/api/meetings?schoolCode=${schoolCode}`)
    .then((res) => {
...
const handleAddAgenda = () => {
  ...
  axios.post('https://cleezoclass.com:5000/api/agenda', {
    meetingNo,
...
const handleUploadMinutes = (file) => {
  ...
  axios
    .post("https://cleezoclass.com:5000/minutes/upload", formData, {
...
const handleEditMinutes = (id) => {
  ...
  axios.put(`https://cleezoclass.com:5000/api/minutes/edit/${id}`, formData, {
    headers: { 'Content-Type': 'multipart/form-data' }
  })
  .then(res => {
    setPopup({
...
const handleDeleteMinutes = (id) => {
  const schoolCode = localStorage.getItem('schoolCode');
  axios.delete(`https://cleezoclass.com:5000/api/minutes/delete/${id}`, { params: { schoolCode } })
    .then(res => {
      setPopup({
...
const fetchMeetingMinutes = () => {
  ...
  axios
    .get('https://cleezoclass.com:5000/minutes', {
      params: { schoolCode }
    })
    .then(res => {
...
const handleScheduleRequest = () => {
  ...
  axios.post('https://cleezoclass.com:5000/api/schedule', {
    class: schClass,
    section: schSection,
    date: schDate,
    time: schTime,
...
const fetchIndCurriculum = async (className, section) => {
  try {
    ...
    const res = await axios.get(
      `https://cleezoclass.com:5000/api/admin/curriculum/${className}/${section}`,
      { params: { schoolCode } }
    );
...
const fetchGrpCurriculum = async (className, section) => {
  ...
  useEffect(() => {
    ...
    axios.get('https://cleezoclass.com:5000/api/party1', params).then(res => setParty1List(res.data));
    axios.get('https://cleezoclass.com:5000/api/classes', params).then(res => setClasses(res.data));
    fetchChatRequests();
  ...
  useEffect(() => {
    ...
    if (classToFetch) {
      ...
      axios.get(`https://cleezoclass.com:5000/api/sections/${classToFetch}`, { params: { schoolCode } })
        .then(res => {
  ...
  useEffect(() => {
    ...
    if (indClass && indSection) {
      // Pass schoolCode as a query parameter
      axios.get(`https://cleezoclass.com:5000/api/admin/students/${indClass}/${indSection}`, { params: { schoolCode } }).then(res => setStudents(res.data));
      setIndStudent('');
    }
  }, [indClass, indSection]);
...
useEffect(() => {
  ...
  axios.get(
    "https://cleezoclass.com:5000/api/chat_requests/sessions",
    { params: { schoolCode } }
  )
    .then(res => {
  ...
  const fetchChatRequests = () => {
    const schoolCode = localStorage.getItem('schoolCode');
    axios.get('https://cleezoclass.com:5000/api/chat-requests', { params: { schoolCode } })
      .then(res => {
        const removedIds = getRemovedIds();
...
const handleIndividualChat = () => {
  ...
  axios.post('https://cleezoclass.com:5000/api/chat-request', {
