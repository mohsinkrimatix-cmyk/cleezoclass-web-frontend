...
const allFeeTypes = [
  ...
  const handleBusFeeSelect = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://cleezoclass.com:5000/get-students?className=${apiClassName}&section=${section}&schoolCode=${schoolCode}`);
  ...
  useEffect(() => {
    const fetchOldBusFee = async () => {
      try {
        ...
        const response = await axios.post('https://cleezoclass.com:5000/get-bus-fee', {
    ...
    const fetchClassAndSectionMetadata = async () => {
      try {
        ...
        const [classRes, sectionRes] = await Promise.all([
          axios.get('https://cleezoclass.com:5000/api/admin/classes', {
            params: { schoolCode },
          }),
          axios.get('https://cleezoclass.com:5000/api/admin/sectionFilter', {
            params: { schoolCode },
          }),
        ]);
  ...
  useEffect(() => {
    const fetchDynamicFeeTypes = async () => {
      try {
        ...
        const response = await axios.get('https://cleezoclass.com:5000/api/fee-types', {
          params: { schoolCode },
        });
          ...
          termWiseFees.map(async (fee) => {
            try {
              const installmentResponse = await axios.get(
                "https://cleezoclass.com:5000/api/fee-type-installments",
                {
                  params: {
                    schoolCode,
                    feeTypeId: fee.id,
    ...
    const fetchFeeStructure = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://cleezoclass.com:5000/feeStructure/${className}`,
...
useEffect(() => {
  const fetchOldPreviousFeeDue = async () => {
    try {
      const schoolCode = localStorage.getItem('schoolCode');
      const response = await axios.post('https://cleezoclass.com:5000/get-previous-feedue', {
...
useEffect(() => {
  const fetchOldResidentialFee = async () => {
    try {
      const schoolCode = localStorage.getItem('schoolCode');
      const response = await axios.post('https://cleezoclass.com:5000/get-residential-fee', {
...
const loadInstallmentsForFeeType = async (feeTypeId, fallbackCount, fallbackAmount) => {
  ...
  try {
    ...
    const response = await axios.get("https://cleezoclass.com:5000/api/fee-type-installments", {
      params: {
        schoolCode,
        feeTypeId,
        className,
...
const openIndividualFeeStudentPicker = async (fee) => {
 ...
 console.log("[INDIVIDUAL FEE POPUP] feeWithFrequency:", feeWithFrequency);
      ...
      feeStudents.map(async (student) => {
        try {
          ...
          for (const classOption of classNameOptions) {
            try {
              response = await axios.get('https://cleezoclass.com:5000/api/student-fee-details', {
                params: {
                  schoolCode,
                  class: classOption,
                  section,
          ...
          if (savedAmount === undefined && studentId) {
            try {
              const historyResponse = await axios.get(
                `https://cleezoclass.com:5000/api/paymentHistory/${studentId}`,
                {
                  params: { schoolCode },
                }
              );
  ...
  const handleDeleteFeeType = async (fee) => {
    ...
    try {
      const schoolCode = localStorage.getItem("schoolCode") || "TAGSOLNOVALLP";
      await axios.delete(`https://cleezoclass.com:5000/api/fee-types/${fee.id}`, {
        params: { schoolCode },
      });
...
const openIndividualStudentInstallments = (student) => {
  ...
  const loadStudents = async () => {
    ...
    try {
      const response = await fetch(`https://cleezoclass.com:5000/get-students?className=${apiClassName}&section=${section}&schoolCode=${schoolCode}`);
...
const handleSaveFeeTypeInstallments = async () => {
  try {
    ...
    const response = await fetch('https://cleezoclass.com:5000/api/fee-type-installments', {
      method: 'POST',
      headers: {
...
const submitIncomeData = async ({
  ...
  try {
    ...
    const response = await axios.put(
      'https://cleezoclass.com:5000/income',
      incomeData
    );
    ...
    const fetchStudentDiscount = async () => {
      try {
        ...
        const response = await fetch(
          `https://cleezoclass.com:5000/get-student-discount?studentName=${encodeURIComponent(selectedStudent.name)}&className=${apiClassName}&sectionName=${section}&schoolCode=${schoolCode}`
        );
...
useEffect(() => {
  const fetchOldAdmissionFee = async () => {
    try {
      const schoolCode = localStorage.getItem('schoolCode');
      const response = await axios.post('https://cleezoclass.com:5000/pay-admission-fee', {
      ...
      <button
        ...
        onClick={async () => {
          try {
            const schoolCode = localStorage.getItem("schoolCode") || "TAGSOLNOVALLP";
            const response = await axios.post(
              "https://cleezoclass.com:5000/pay-previous-feedue",
              {
                studentName: selectedPreviousFeeDueStudent.name,
                className: className.replace("Class ", ""),
                sectionName: section,
      ...
      <button
        ...
        onClick={async () => {
          try {
            const schoolCode = localStorage.getItem("schoolCode") || "TAGSOLNOVALLP";
            const response = await axios.post(
              "https://cleezoclass.com:5000/pay-residential-fee",
              {
                studentName: selectedResidentialStudent.name,
                className: className.replace("Class ", ""),
                sectionName: section,
      ...
      <button
        ...
        onClick={async () => {
          try {
            const schoolCode = localStorage.getItem("schoolCode") || "TAGSOLNOVALLP";
            const response = await axios.post(
              "https://cleezoclass.com:5000/pay-admission-fee",
              {
                studentName: selectedAdmissionStudent.name,
                className: className.replace("Class ", ""),
                sectionName: section,
            ...
            <button
              ...
              onClick={async () => {
                try {
                  const schoolCode = localStorage.getItem("schoolCode") || "TAGSOLNOVALLP";
                  const response = await axios.post(
                    "https://cleezoclass.com:5000/pay-bus-fee",
                    {
                      studentName: selectedBusStudent.name,
                      className: className.replace("Class ", ""),
                      sectionName: section,
