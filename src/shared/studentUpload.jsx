...
useEffect(() => {
  ...
  const handleConfirmSubmit = async () => {
    ...
    try {
      const response = await fetch(`https://cleezoclass.com:5000/api/upload-excel/student?schoolCode=${encodeURIComponent(schoolCode)}`, {
        method: "POST",
        body: formData,
      });
  ...
  const fetchStudents = () => {
    axios.get('https://cleezoclass.com:5000/api/students')
...
useEffect(() => {
  ...
  try {
    const response = await axios.post('https://cleezoclass.com:5000/api/whatsapp/send-messagewhatsapp', {
...
//   const fetchQR = async () => {
//     try {
//       const res =await fetch(`https://cleezoclass.com:5000/api/whatsapp/qr?schoolCode=${schoolId}`);
