...
const TrackExpenses = ({ isMobile, font, addAction }) => {
  ...
  const handleSendToAdmin = async () => {
    ...
    try {
      await axios.post("https://cleezoclass.com:5000/expenses-superadmin", { schoolCode, expenses: filtered });
  ...
  const fetchAllExpenses = async () => {
    try {
      const res = await axios.get(`https://cleezoclass.com:5000/api/totalexpenses?schoolCode=${schoolCode}`);
  ...
  const fetchChartData = async () => {
    ...
    try {
      const expRes = await axios.get(`https://cleezoclass.com:5000/api/totalexpenses?schoolCode=${schoolCode}`);
