...
const ExpenseManagement = () => {
 ...
 if (tab === 'LEDGER') {
  ...
  const fetchMaintenanceData = async (dateRange, schoolCode) => {
    let url = "https://cleezoclass.com:5000/api/totalcost";
  ...
  const fetchDepreciationData = async (dateRange, schoolCode) => {
    let url = "https://cleezoclass.com:5000/api/totaldepreciation";
    const params = new URLSearchParams();
    if (dateRange.includes(" to ")) {
      const [startDate, endDate] = dateRange.split(" to ");
      params.append("startDate", startDate);
  ...
  const fetchGoodwillData = async (dateRange, schoolCode) => {
    let url = "https://cleezoclass.com:5000/expensesgoodwill";
    const params = new URLSearchParams();
    if (dateRange.includes(" to ")) {
      const [startDate, endDate] = dateRange.split(" to ");
      params.append("startDate", startDate);
  ...
  const fetchFeeData = async (dateRange, schoolCode) => {
    try {
      ...
      const url = `https://cleezoclass.com:5000/api/feeDataFinance?schoolCode=${schoolCode}`;
  ...
  const fetchScannerData = async (dateRange, schoolCode) => {
    try {
      ...
      const url = `https://cleezoclass.com:5000/getAllBills`;
