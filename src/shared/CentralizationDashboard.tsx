...
const downloadBackup = async () => {
  try {
    ...
    const response = await axios.get(
      "https://cleezoclass.com:4000/api/download-backup",
      {
        params: {
          schoolCode,
        },
              ...
              <div style={styles.row}>
                <div style={{ ...styles.inputGroup, flex: 1, marginRight: '15px' }}>
                  ...
                  <input
                    ...
                    style={detailsInputStyle('latitude')}
                  />
                  {renderDetailsError('latitude')}
                </div>
                <div style={{ ...styles.inputGroup, flex: 1, marginRight: '15px' }}>
                  ...
                  <input
                    ...
                    style={detailsInputStyle('longitude')}
                  />
                  {renderDetailsError('longitude')}
                </div>
                <div style={{ ...styles.inputGroup, flex: 1 }}>
                  ...
                  <input
                    ...
                    style={detailsInputStyle('radius')}
                  />
                  {renderDetailsError('radius')}
                </div>
              </div>
            </div>
