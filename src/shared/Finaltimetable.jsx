...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const { data } = await axios.post(
      "https://cleezoclass.com:5000/generatetimetable",
      payload,
...
useEffect(() => {
  ...
  if (schoolCode) {
    ...
    //  axios.post('https://cleezoclass.com:5000app/school-init', { schoolCode })
    //  axios.post('https://cleezoclass.com:5000app/school-init', { schoolCode })
     axios.post('https://cleezoclass.com:5000app/school-init', { schoolCode })
...
useEffect(() => {
  const schoolCode = localStorage.getItem('schoolCode');
  fetch(`https://cleezoclass.com:5000app/getteacher?schoolCode=${encodeURIComponent(schoolCode)}`)
  ...
  const fetchSchoolLogo = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        // 'https://cleezoclass.com:5000app/schoollogodynamic',
        'https://cleezoclass.com:5000app/schoollogodynamic',
        { secretecode: code },
        {
          headers: {
