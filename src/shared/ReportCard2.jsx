...
useEffect(() => {
  const fetchBehaviour = async () => {
    ...
    try {
      const response = await axios.post('https://cleezoclass.com:5000/api/api/behaviour', {
        name,
...
useEffect(() => {
  const fetchAttendance = async () => {
    if (!name || !studentClass || !section) return;
    try {
      const response = await axios.post('https://cleezoclass.com:5000/api/api/attendance', {
        name,
        class_name: studentClass,
        section,
        school_code: schoolCode,
...
useEffect(() => {
  const fetchActivities = async () => {
    if (!name || !studentClass || !section) return;
    try {
      const response = await axios.post('https://cleezoclass.com:5000/api/api/activities', {
        name,
        class_name: studentClass,
        section,
        school_code: schoolCode,
...
useEffect(() => {
  const fetchAcademicPerformance = async () => {
    if (!name || !studentClass || !section) return;
    try {
      const response = await axios.post('https://cleezoclass.com:5000/api/api/academic-performance', {
        name,
        class_name: studentClass,
        section,
        school_code: schoolCode,
...
useEffect(() => {
  const fetchStudentDetails = async () => {
    if (!name || !studentClass || !section) return;
    try {
      const response = await axios.post('https://cleezoclass.com:5000/api/api/student-details', {
        name,
        class_name: studentClass,
        section,
        school_code: schoolCode,
