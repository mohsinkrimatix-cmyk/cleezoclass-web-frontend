...
const GenerateBillPrint = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://cleezoclass.com:5000/api/studentsName/${selectedClass}?schoolCode=${schoolCode}`)
      .then(res => {
  ...
  useEffect(() => {
    ...
    const schoolCode = localStorage.getItem('schoolCode');
    axios.get(`https://cleezoclass.com:5000/api/feeStructure/${selectedStudentId}?schoolCode=${schoolCode}`)
      .then(feeRes => {
...
const searchBillsByReceiptNumber = async () => {
    ...
    try {
        ...
        const response = await axios.get(
            `https://cleezoclass.com:5000/api/bill/find/${searchTerm}`,
            { params: { schoolCode } }
        );
        ...
        if (response.data?.bill) {
            ...
            const imageUrl = `https://cleezoclass.com:5000/${cleanImagePath}`;
