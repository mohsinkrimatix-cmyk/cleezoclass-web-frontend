  ...
  useEffect(() => {
    const fetchClassSections = async () => {
      try {
        ...
        const response = await axios.get('https://cleezoclass.com:5000/api/class-sections', {
          params: { schoolCode },
        });
  ...
  useEffect(() => {
    const fetchUnpaidStudents = async () => {
      ...
      try {
        ...
        const response = await axios.get('https://cleezoclass.com:5000/api/fee-payment-status', {
