...
export default function EnrollmentBiometrics() {
    ...
    const fetchAdmissions = async () => {
      try {
        const response = await axios.get(
          "https://cleezoclass.com:5000/newadmissions",
          {
            params: { schoolCode },
          }
        );
    ...
    const fetchAllTeachers = async () => {
      ...
      try {
        const response = await axios.post(
          "https://cleezoclass.com:5000/api/users",
          {
            schoolCode,
            user_type: "teacher",
          }
  ...
  const fetchReport = async (month) => {
    try {
      const res = await axios.get(
        `https://cleezoclass.com:5000/api/salary-report?month=${month}`
      );
      setReport(res.data);
    } catch (err) {
      console.error(err);
  ...
  const fetchReport1 = async (month) => {
    ...
    try {
      const deductionRes = await axios.get(
        `https://cleezoclass.com:5000/api/monthly-deductions?month=${month}`
      );
      const lateRes = await axios.get(
        `https://cleezoclass.com:5000/teacher-list-of-latecomers-time`,
        {
