    ...
    const fetchHeaderUser = async () => {
      ...
      try {
        const response = await axios.get(
          `https://cleezoclass.com:5000/api/api/user-info/${username}`,
          { params: { schoolCode } }
        );
...
useEffect(() => {
  ...
  const handleEditClick = (teacher) => {
    ...
    setPhotoPreview(teacher.photo ? `https://cleezoclass.com:5000${teacher.photo}` : '');
    setPhotoFile(null);
  };
  ...
  const uploadPhoto = async (photoFile, teacherId) => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://cleezoclass.com:5000/upload-photo-teacherdatainsertion',
        formData,
        {
          headers: {
  ...
  const handleDelete = async (teacherId) => {
    if (window.confirm('Are you sure you want to delete this teacher?')) {
      try {
        await axios.delete(`https://cleezoclass.com:5000/api/users/${teacherId}`, { data: { schoolCode } });
        const response = await axios.post('https://cleezoclass.com:5000/api/users', { schoolCode, user_type: selectedUserType });
        setTeachers(response.data);
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://cleezoclass.com:5000/api/users/${editingTeacher}`, {
        ...editFormData,
        photo: photoPath,
        schoolCode,
      });
