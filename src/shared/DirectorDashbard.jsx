                            ...
                            {bills.map(bill => (
                                <div key={bill.image_path} style={modalStyles.billCard}>
                                    ...
                                    <div style={modalStyles.imageContainer}>
                                        <img
                                            src={`https://cleezoclass.com:5000/${bill.image_path}`}
...
const Dashboard = React.forwardRef(({ pendingRequests, isPendingLoading, pendingRequestsError, handleRequestStatusUpdate, pendingActivitiesData, studentCount, studentStats  }, ref) => {
    ...
    const [infoPopupData, setInfoPopupData] = useState(null);
     ...
     const fetchTeacherDetails = async (teacherId) => {
        ...
        try {
            const response = await fetch(`https://cleezoclass.com:5000/teacher/${teacherId}?schoolCode=${schoolCode}`);
            if (!response.ok) {
...
const fetchInfoPopupData = async () => {
    ...
    try {
        ...
        const expenseResponse = await axios.post("https://cleezoclass.com:5000/api/getExpenseData", { schoolCode });
    ...
    const fetchStudentAttendance = async (filters) => {
        ...
        try {
            const response = await axios.get('https://cleezoclass.com:5000/api/student-leavesapprovalrequest', { 
    ...
    const fetchIncomeDetails = async (filters) => {
        ...
        setPaidStudents([]);
        try {
            const response = await axios.get('https://cleezoclass.com:5000/api/income/details', {
            params: { schoolCode, ...filters },
    ...
    const fetchLatecomers = async () => {
        ...
        setError(null);
        try {
            const latecomersRes = await axios.get(`https://cleezoclass.com:5000/api/latecomers/today?schoolCode=${schoolCode}`);
            ...
            const detailedLatecomers = await Promise.all(
                todayLatecomers.map(async (teacher) => {
                    try {
                        const detailsRes = await axios.get('https://cleezoclass.com:5000/api/latecomer-details', {
    ...
    try {
        ...
        const response = await axios.get(`https://cleezoclass.com:5000/api/edited-bills`, {
...
const fetchExpenseRequests = async (date) => {
    ...
    setError(null);
    try {
        const response = await axios.get(`https://cleezoclass.com:5000/api/expense-requests`, {
        ...
        try {
            const response = await axios.get(`https://cleezoclass.com:5000/api/student-bill-history`, {
            params: {
                schoolCode,
    ...
    const fetchLeaveRequests = async () => {
        ...
        setError(null);
        try {
            const response = await axios.get(`https://cleezoclass.com:5000/api/leave-requests/all?schoolCode=${schoolCode}`);
    ...
    useEffect(() => {
        const fetchClassSections = async () => {
            if (!schoolCode) return;
            try {
                const response = await axios.get('https://cleezoclass.com:5000/api/class-sections', { params: { schoolCode } });
    ...
    const [selectedDate, setSelectedDate] = useState(today);
        ...
        const fetchAttendanceData = async () => {
            ...
            try {
                const arrivedPromise = axios.get(`https://cleezoclass.com:5000/api/teachers_attendance/arrived`, {
                    params: { date: selectedDate, schoolCode: currentSchoolCode }
                });
                const unarrivedPromise = axios.get(`https://cleezoclass.com:5000/api/teachers_attendance/unarrived`, {
                    params: { date: selectedDate, schoolCode: currentSchoolCode }
                });
...
const updateDateRange = (option) => {
    ...
    const fetchPendingRequests = async () => {
        ...
        try {
            const response = await axios.get(`https://cleezoclass.com:5000/api/expense-requests/pending`, { params: { schoolCode } });
    ...
    const handleRequestStatusUpdate = async (id, status) => {
        try {
            await axios.put(`https://cleezoclass.com:5000/api/expense-request/${id}/status`, { status, schoolCode });
...
useEffect(() => {
    const fetchUpdateCounts = async () => {
        ...
        try {
            ...
            const editedBillsResponse = await axios.get(`https://cleezoclass.com:5000/api/edited-bills`, {
            ...
            const expenseRequestsResponse = await axios.get(`https://cleezoclass.com:5000/api/expense-requests`, {
...
useEffect(() => {
    const fetchAllDailyStats = async () => {
        ...
        try {
            ...
            const [financialSummaryRes, feeDataRes] = await Promise.all([
                axios.get(`https://cleezoclass.com:5000/api/financial-summary/today?schoolCode=${schoolCode}`),
                axios.post(`https://cleezoclass.com:5000/api/feeDataFinanceNew`, { schoolCode, date: new Date().toISOString().split('T')[0] })
            ]);
    ...
    useEffect(() => {
        const fetchAttendanceSummary = async () => {
            ...
            try {
                ...
                const promises = [
                    axios.get(`https://cleezoclass.com:5000/api/latecomers/today?schoolCode=${schoolCode}`).catch(e => ({ data: [] })), // Return empty data on failure
                    axios.get(`https://cleezoclass.com:5000/api/leave-requests/all?schoolCode=${schoolCode}`).catch(e => ({ data: [] })),
                    axios.get(`https://cleezoclass.com:5000/api/teachers_attendance/unarrived`, { params: { date: today, schoolCode: schoolCode } }).catch(e => ({ data: [] })),
                    axios.get(`https://cleezoclass.com:5000/api/student-leaves?schoolCode=${schoolCode}`).catch(e => ({ data: [] }))
                ];
        ...
        const fetchPendingActivities = async () => {
            ...
            try {
                const response = await axios.get(`https://cleezoclass.com:5000/api/pending-activities?schoolCode=${schoolCode}`);
    ...
    useEffect(() => {
        const fetchStudentCount = async () => {
            ...
            try {
                const response = await axios.get(`https://cleezoclass.com:5000/api/students/count?schoolCode=${schoolCode}`);
...
useEffect(() => {
    const fetchStudentStats = async () => {
        ...
        try {
            ...
            const url = `https://cleezoclass.com:5000/api/feeDataFinanceNew?schoolCode=${schoolCode}`;
            ...
            const studentCountsResponse = await axios.post(`https://cleezoclass.com:5000/api/studentCounts?schoolCode=${schoolCode}`);
    ...
    useEffect(() => {
        const fetchSchoolLogo = async () => {
            ...
            try {
                const response = await axios.post('https://cleezoclass.com:5000/api/schoollogodynamic', { secretecode: code });
