...
const normalizeInstituteLogo = (logoUrl) => {
  ...
  return logoUrl.startsWith('http') ? logoUrl : `https://cleezoclass.com:5000/${logoUrl}`;
};
...
const TeacherSalaryTable1 = () => {
  ...
  useEffect(() => {
    const fetchTeacherData = async () => {
      ...
      try {
        const response = await fetch(`https://cleezoclass.com:5000/api/teach?schoolCode=${encodeURIComponent(schoolCode)}`);
