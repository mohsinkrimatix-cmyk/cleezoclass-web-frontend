...
const handleSendToChief = async () => {
  ...
  try {
    ...
    await axios.post(`https://cleezoclass.com:5000/chief/fee-report-to-superAdmin`, {
      schoolCode,
...
const handleStudentTransactions = useCallback(async () => {
  ...
  try {
    ...
    const res = await axios.get(
      `https://cleezoclass.com:5000/api/student-transactions?${params.toString()}`
    );
  ...
  useEffect(() => {
    ...
    fetch(`https://cleezoclass.com:5000/api/institute?dbName=${currentDbName}`)
      .then((res) => res.json())
      .then((data) => {
    ...
    try {
      ...
      if (selectedYear === "2024-2025") {
        ...
        const prevRes = await axios.get(
          `https://cleezoclass.com:5000/api/fee-records-alldata?${prevParams.toString()}`
        );
      ...
      const res = await axios.get(`https://cleezoclass.com:5000/api/fees-summary-ledgerData?${params.toString()}`);
  ...
  const handleTodayLedger = async () => {
    ...
    try {
      ...
      const res = await axios.get(`https://cleezoclass.com:5000/api/ledger?${params.toString()}`);
  ...
  const handlePreviousReport = async () => {
    ...
    try {
      ...
      const res = await axios.get(`https://cleezoclass.com:5000/api/fee-records-alldata?${params}`);
      const result = Array.isArray(res.data) ? res.data : res.data.data || [];
...
const handleCompleteFeeReport = async () => {
  ...
  try {
    ...
    const apiUrl = `https://cleezoclass.com:5000/api/fee-records-alldata?${params}`;
    console.log("🌐 API URL:", apiUrl);
...
const Collections = ({
  ...
  useEffect(() => {
    ...
    axios
      .get("https://cleezoclass.com:5000/api/feeDetailsByClassSection", {
  ...
  const sendLetter = async () => {
    ...
    try {
      const response = await fetch(
        "https://cleezoclass.com:5000/report/insert-letter",
        {
          method: "POST",
          body: formData,
        }
...
const handleFetchSummary = async () => {
  ...
  const url = `https://cleezoclass.com:5000/api/fees-summary-ledgerData?schoolCode=${schoolCode}`;
...
setPreviousTotals({
  ...
  const fetchPaidList = async () => {
    ...
    const url = `https://cleezoclass.com:5000/api/paid-list?schoolCode=${schoolCode}&fromDate=${fromDate || ""}&toDate=${toDate || ""}&className=${className}&section=${section}`;
...
const fetchUnpaidList = async () => {
  ...
  const url = `https://cleezoclass.com:5000/api/unpaid-list?schoolCode=${schoolCode}&fromDate=${fromDate || ""}&toDate=${toDate || ""}&className=${className}&section=${section}`;
...
console.log("🔍 All Keys:", Object.keys(data[0]));
  ...
  const fetchChartData = async () => {
    ...
    const url = `https://cleezoclass.com:5000/api/summary-daily?schoolCode=${schoolCode}&fromDate=${fromDate || ""}&toDate=${toDate || ""}&className=${className}&section=${section}`;
