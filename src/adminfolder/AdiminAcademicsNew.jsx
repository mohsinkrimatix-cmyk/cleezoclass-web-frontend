...
const API_BASE = "https://cleezoclass.com:5000/api/admin";
const ROOT_API_BASE = "https://cleezoclass.com:5000/api";
...
const getAttendanceRadius = async () => {
  try {
    ...
    const response = await axios.get(
      `https://cleezoclass.com:5000/api/attendance-radius`,
      {
        params: { schoolCode },
      }
    );
  ...
  const fetchPoItems = async () => {
    ...
    try {
      const res = await fetch(`https://cleezoclass.com:5000/api/po/requests?schoolCode=${schoolCode}`);
    ...
    const loadAttendanceSettings = async () => {
      try {
        const [alertRes, teacherRes] = await Promise.all([
          axios.get("https://cleezoclass.com:5000/api/attendance/get-alert-time", {
            params: { schoolCode },
          }),
          axios.get("https://cleezoclass.com:5000/attendance/get-login-logout-time", {
            params: { schoolCode },
          }),
        ]);
  ...
  const handleResetStudentAlertTime = async () => {
    ...
    try {
      await axios.post("https://cleezoclass.com:5000/api/attendance/reset-alert-time", {
        schoolCode,
      });
      setStudentAlertTime(null);
    } catch (error) {
  ...
  const handleResetTeacherAttendanceTime = async () => {
    ...
    try {
      await axios.post("https://cleezoclass.com:5000/attendance/reset-login-logout-time", {
        schoolCode,
      });
      setTeacherAttendanceTimes(null);
    } catch (error) {
  ...
  const handleTeacherCardClick = async (teacher) => {
    ...
    try {
      const [teacherRes, salaryRes] = await Promise.all([
        fetch(`https://cleezoclass.com:5000/teacher/${teacherId}?schoolCode=${encodeURIComponent(schoolCode)}`),
        fetch(
          `https://cleezoclass.com:5000/api/salary/${teacherId}?schoolCode=${encodeURIComponent(schoolCode)}`
        ),
      ]);
  ...
  useEffect(() => {
    ...
    const loadChatRequests = async () => {
      ...
      setChatError("");
      try {
        const { data } = await axios.get(`https://cleezoclass.com:5000/api/chat-requests`, {
          params: { schoolCode },
        });
    ...
    const loadLiveChatMeta = async () => {
      try {
        const [{ data: staffData }, { data: classData }] = await Promise.all([
          axios.get("https://cleezoclass.com:5000/api/party1", { params: { schoolCode } }),
          axios.get("https://cleezoclass.com:5000/api/classes", { params: { schoolCode } }),
        ]);
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://cleezoclass.com:5000/api/sections/${encodeURIComponent(liveChatForm.className)}`, {
        params: { schoolCode },
      })
      .then((res) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://cleezoclass.com:5000/api/admin/students/${encodeURIComponent(liveChatForm.className)}/${encodeURIComponent(liveChatForm.section)}`,
        { params: { schoolCode } }
      )
      .then((res) => {
  ...
  const handleCreateLiveChatRequest = async () => {
    ...
    try {
      const { data } = await axios.post("https://cleezoclass.com:5000/api/chat-request", {
      ...
      closePopup();
      if (schoolCode) {
        const { data: refreshed } = await axios.get("https://cleezoclass.com:5000/api/chat-requests", {
          params: { schoolCode },
        });
  ...
  const handleProcessPO = async (item, newStatus) => {
    ...
    try {
      const response = await fetch("https://cleezoclass.com:5000/api/po/process", {
        method: "POST",
  ...
  useEffect(() => {
    ...
    Promise.all(
      teachers.map(async (teacher) => {
        ...
        try {
          const response = await axios.get(`https://cleezoclass.com:5000/teacher/${teacherId}`, {
            params: { schoolCode },
          });
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://cleezoclass.com:5000/api/studentsNameAccountant/${className}?schoolCode=${schoolCode}&section=${section}`
      )
      .then((res) => {
  ...
  //           axios.post(
  //             "https://cleezoclass.com:5000/api/overall/academic-performance",
  //             payload
  //           ),
  //           axios.post(
  //             "https://cleezoclass.com:5000/api/report/attendance/monthly",
  //             payload
  //           ),
  //         ]);
  //         return [
  ...
  useEffect(() => {
    ...
    Promise.all([
      axios.post("https://cleezoclass.com:5000/api/overall/academic-performance", payload),
      axios.post("https://cleezoclass.com:5000/api/report/attendance/monthly", payload),
      axios.get("https://cleezoclass.com:5000/api/student/behavior", { params: payload }),
    ])
                    ...
                    filteredStudents.map((student, index) => (
                      ...
                      >
                        <div className="admin-academics-student-avatar-wrap">
                          {student.photo?.data ? (
                            <img
                              src={`https://cleezoclass.com:5000${bufferToPathString(
                                student.photo.data
                              )}`}
