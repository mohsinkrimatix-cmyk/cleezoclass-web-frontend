    ...
    const fetchAdminAssistantData = async () => {
      ...
      try {
        ...
        const [studentsRes, teachersRes, latecomersRes, leaveReqRes] = await Promise.allSettled([
          axios.get(`https://cleezoclass.com:5000/api/students/count`, { params: { schoolCode } }),
          axios.get(`https://cleezoclass.com:5000/api/teacher/count`, { params: { schoolCode } }),
          axios.get(`https://cleezoclass.com:5000/api/teacher-list-of-latecomers`, {
            params: { schoolCode, month, year },
          }),
          axios.get(`https://cleezoclass.com:5000/api/leave-requests/all`, { params: { schoolCode } }),
        ]);
...
const isLargeMonitor = window.innerWidth > 1440;
 ...
 const handleStudentSelect = async (student) => {
  ...
  return (
    <div className="AdminDashboard-outercontainer">
