...
import ErrorPopup from '../shared/ErrorPopup';
    const API_BASE = 'https://cleezoclass.com:5000/api/'; // Match your backend PORT
...
const fetchSyllabusTopics = async () => {
  ...
  try {
    ...
    const res = await axios.get(
      "https://cleezoclass.com:5000/api/extract-topics",
      {
        params: {
...
setPopup({
  ...
  try {
    ...
    const response = await axios.post('https://cleezoclass.com:5000/QuestionPaper', {
...
useEffect(() => {
  ...
  axios.get('https://cleezoclass.com:5000/api/pending-classes', {
  ...
  const handleClassChange = (event) => {
    ...
    if (classLevel && board && schoolCode) {
      setLoading(true);
      axios.get(`https://cleezoclass.com:5000/subjects/${classLevel}/${board}?schoolCode=${schoolCode}`)
        .then((response) => {
...
const fetchComplaints = async () => {
  try {
    const schoolCode = localStorage.getItem("schoolCode");
    const res = await axios.get("https://cleezoclass.com:5000/api/complaints", {
      params: { schoolCode }
    });
...
const handleReportTeacher = async ({ teacher, subject, classes }) => {
  ...
  try {
    ...
    await axios.post("https://cleezoclass.com:5000/api/complaints", {
      schoolCode,
      type: "teacher_report",
      teacher,
      subject,
...
const handleComplainAdmin = async ({ teacher, subject, classes, message }) => {
  ...
  useEffect(() => {
    ...
    axios.get('https://cleezoclass.com:5000/api/class-sections', { params: { schoolCode } })
      .then(res => {
    ...
    // Fetch teacher names
    axios.get('https://cleezoclass.com:5000/teachers', { params: { schoolCode } })
      .then(res => setTeachers(res.data))
      .catch(err => console.error('Error fetching teachers:', err));
    // Fetch school logo
    axios.post('https://cleezoclass.com:5000/api/schoollogodynamic', { secretecode: schoolCode })
      .then(res => {
...
useEffect(() => {
  ...
  const handleBoardChange = (event) => {
    ...
    if (selectedBoard && selectedClass) {
      setLoading(true);
      axios.get(`https://cleezoclass.com:5000/api/subjects/${selectedClass}/${selectedBoard}`)
        .then((response) => {
          setSubjects(response.data);
          setLoading(false);
        })
...
const handleGenerateQuestionPaper = () => {
  ...
  axios.post('https://cleezoclass.com:5000/QuestionPaper', {
    class: selectedClass,
...
const handleAssign = () => {
  ...
  axios.post('https://cleezoclass.com:5000/assign-invigilator', {
...
const handleRecommendation = () => {
  ...
  axios.get("https://cleezoclass.com:5000/api/recommended-invigilators", {
    params: {
      class_name: selectedClassInvigilator,
...
setPopup({
  ...
  `https://cleezoclass.com:5000/api/admin/api/metadata?schoolCode=${schoolCode}`
);
