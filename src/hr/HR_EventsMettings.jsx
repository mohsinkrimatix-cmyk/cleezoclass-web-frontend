    ...
    const fetchUserName = async () => {
      ...
      try {
        const response = await fetch(
          `https://cleezoclass.com:5000/getUserName?username=${encodeURIComponent(username)}`
        );
    ...
    const fetchData = async () => {
      try {
        const [deletedRes, leaveRes] = await Promise.all([
          axios.get("https://cleezoclass.com:5000/api/deleted-teachers", { params: { schoolCode } }),
          axios.get("https://cleezoclass.com:5000/leave-requests-list", { params: { schoolCode } }),
        ]);
