...
export default function EventsMeetingsChief() {
  ...
  const fetchChatSummary = async () => {
    try {
      const res = await axios.get("https://cleezoclass.com:4000/api/chat-summary", {
        params: { schoolCode },
      });
  ...
  const fetchTotalEvents = async () => {
    try {
      const res = await axios.get("https://cleezoclass.com:4000/api/event-summary", {
        params: { schoolCode },
      });
  ...
  const fetchUpcomingEvents = async () => {
    ...
    try {
      ...
      const res = await axios.get("https://cleezoclass.com:4000/api/upcoming-events", {
        params: { schoolCode },
      });
