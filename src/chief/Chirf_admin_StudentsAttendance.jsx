...
function StudentsAttendance() {
  ...
  const fetchHighestScorer = async (className) => {
    try {
      const response = await axios.post('https://cleezoclass.com:5000/api/api/highest-scorer', {
  ...
  const fetchOverallHighestScorer = async () => {
    try {
      const response = await axios.post('https://cleezoclass.com:5000/api/api/overall-highest-scorer', {
        school_code: schoolCode, // ✅ send schoolCode
      });
  ...
  const fetchMostAppreciatedStudent = async () => {
    try {
      const response = await axios.post('https://cleezoclass.com:5000/api/api/student-most-positive-comments', {
        school_code: schoolCode, // ✅ send schoolCode
      });
