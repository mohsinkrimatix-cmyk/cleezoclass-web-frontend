    ...
    const fetchExamData = async () => {
      ...
      try {
        const [qpRes, invigilatorRes, seatingRes] = await Promise.all([
          axios.get("https://cleezoclass.com:5000/api/qp-pending", { params: { schoolCode, examType: selectedExamType } }),
          axios.get("https://cleezoclass.com:5000/api/invigilator-status", { params: { schoolCode, examType: selectedExamType } }),
          axios.get("https://cleezoclass.com:5000/api/seating-status", { params: { schoolCode, examType: selectedExamType } })
        ]);

        const scanRes = await axios.get('https://cleezoclass.com:5000/api/pending-classes', {
          params: { schoolCode }
        });
