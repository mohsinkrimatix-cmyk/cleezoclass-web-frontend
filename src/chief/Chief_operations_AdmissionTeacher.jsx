...
export default function AdmissionTeacherChief() {
  ...
  const fetchCurrentMonthPresentCount = async (teacherId) => {
    try {
      ...
      const res = await axios.get(
        "https://cleezoclass.com:5000/api/Chiefattendance/current-month-count",
        {
          params: {
            teacherId,
            schoolCode,
  ...
  const fetchAttendanceByTeacherId = async (teacherId) => {
    try {
      ...
      const res = await axios.get(
        "https://cleezoclass.com:5000/api/Chiefattendance",
        {
          params: {
            teacherId,
            schoolCode,
  ...
  useEffect(() => {
    ...
    axios
      .get("https://cleezoclass.com:5000/teachers", {
        params: { schoolCode },
      })
      .then((res) => {
    ...
    axios
      .post("https://cleezoclass.com:5000/api/schoollogodynamic", {
