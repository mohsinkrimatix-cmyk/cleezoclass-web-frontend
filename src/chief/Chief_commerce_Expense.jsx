...
const months = generateMonthsRange(5, 5);
    ...
    const fetchTotals = async () => {
        ...
        try {
            ...
            const response = await axios.get(`https://cleezoclass.com:5000/api/totals?schoolCode=${schoolCodeToUse}`);
    ...
    const fetchAndCalculateSalaryTotals = async (monthYear) => {
        ...
        try {
            ...
            const response = await axios.get(`https://cleezoclass.com:5000/api/salaryLedger?schoolCode=${schoolCode}`);
    ...
    const fetchAndCalculateUtilitiesTotals = async (monthYear) => {
        ...
        try {
            ...
            const response = await axios.get(`https://cleezoclass.com:5000/api/totalexpenses?schoolCode=${schoolCode}`);
    ...
    const fetchChartData = async () => {
        ...
        try {
            ...
            const expensesResponse = await axios.get(`https://cleezoclass.com:5000/api/totalexpenses?schoolCode=${schoolCode}`);
            const rawExpensesData = expensesResponse.data || [];

            // --- 2. Fetch Salaries ---
            const salaryResponse = await axios.get(`https://cleezoclass.com:5000/api/salaryLedger?schoolCode=${schoolCode}`);
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            const expensesPromise = axios.get(`https://cleezoclass.com:5000/totalexpensesData?schoolCode=${schoolCode}`);
