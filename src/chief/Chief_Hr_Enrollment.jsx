...
const fetchTopStudents = async () => {
  try {
    const response = await axios.get("https://cleezoclass.com:5000/top-students", {
      params: { schoolCode }
    });
    ...
    const fetchData = async () => {
      try {
        const [admissionsRes, studentsRes, teachersRes] = await Promise.all([
          axios.get("https://cleezoclass.com:5000/newadmissions", { params: { schoolCode } }),
          axios.get("https://cleezoclass.com:5000/students-details", { params: { schoolCode } }),
          axios.post("https://cleezoclass.com:5000/api/users", { schoolCode, user_type: "teacher" }),
        ]);
  ...
  const fetchAttendanceAndLeaves = async (month, isBiometrics = false) => {
    ...
    try {
      const [irregularsRes, leavesRes] = await Promise.all([
        axios.get("https://cleezoclass.com:5000/list-of-irregulars", { params: { schoolCode, month } }),
        axios.get("https://cleezoclass.com:5000/leave-requests-list", { params: { schoolCode, month } }),
      ]);
