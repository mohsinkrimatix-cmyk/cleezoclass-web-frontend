...
const BiometricTeacher = () => {
  ...
  const fetchDeletedUsers = async () => {
    try {
      const res = await axios.get("https://cleezoclass.com:5000/api/deleted-teachers", {
        params: { schoolCode },
      });
  ...
  const fetchLeaveRequests = async () => {
    try {
      const res = await axios.get("https://cleezoclass.com:5000/teacher-leave-requests-list", {
        params: { schoolCode },
      });
