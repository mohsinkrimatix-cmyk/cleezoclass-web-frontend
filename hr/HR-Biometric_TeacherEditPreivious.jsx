...
useEffect(() => {
  ...
  const handleDelete = async (teacherId) => {
    if (window.confirm('Are you sure you want to delete this teacher?')) {
      try {
        ...
        const response = await axios.post('https://cleezoclass.com:5000/api/users', { schoolCode, user_type: 'teacher' });
        setTeachers(response.data);
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://cleezoclass.com:5000/api/Teacherusers/${editingTeacher}`, {
        ...editFormData,
        photo: photoPath,
        schoolCode,
      });
