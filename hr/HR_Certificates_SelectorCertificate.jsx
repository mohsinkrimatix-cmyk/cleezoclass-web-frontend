...
const CertificateSelector = ({ teacherId, onLocalNavigate }) => {
    ...
    const fetchStudentsOnLoad = async () => {
      ...
      try {
        ...
        const response = await axios.post(
          `https://cleezoclass.com:5000/api/students`,  
  ...
  const handleSchoolChange = (e) => {
    ...
    if (selectedSchool) {
      ...
      axios.get(`https://cleezoclass.com:5000/api/students/${schoolCode}`)
  ...
  useEffect(() => {
    ...
    if (selectedClass) {
      axios.get(`https://cleezoclass.com:5000/api/certificate/${selectedClass}?schoolCode=${schoolCode}`)
...
const handleStudentID = (id) => { 
    ...
    const fetchUserProfile = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://cleezoclass.com:5000/api/profile/${schoolCode}/${username}`
        );
  ...
  const handleAdmnChange = (e) => {
    ...
    const schoolCode = localStorage.getItem('schoolCode');
    if (schoolCode) {
      axios.get(`https://cleezoclass.com:5000/api/student-details/${schoolCode}/${selectedSchoolId}/${selectedAdmn}`)
        .then((res) => {
