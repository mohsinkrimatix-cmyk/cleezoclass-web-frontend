...
useEffect(() => {
  ...
  // Fetch fee structure
  axios
    .get(`https://cleezoclass.com:5000/api/feeStructure/${className}?schoolCode=${schoolCode}`)
    .then((feeRes) => {
  ...
  axios
    .get("https://cleezoclass.com:5000/api/class-installments", {
  ...
  axios
    .get(`https://cleezoclass.com:5000/api/getpaidinstallment/${selectedStudentId}?schoolCode=${schoolCode}`)
  ...
  axios
    .get(`https://cleezoclass.com:5000/api/payment/${selectedStudentId}?schoolCode=${schoolCode}`)
    .then((paymentRes) => {
...
const handlePaymentSubmission = async (e) => {
  ...
  try {
    const response = await fetch(
      "https://cleezoclass.com:5000/trial-pay-fee-detailsincome",
      {
        method: "POST",
