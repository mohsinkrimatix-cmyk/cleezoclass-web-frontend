...
useEffect(() => {
  ...
  axios
    .post("https://cleezoclass.com:5000/get-bus-fee", {
...
const fetchLastReceiptNumber = async () => {
  ...
  try {
    const response = await axios.get(
      `https://cleezoclass.com:5000/api/getLastReceiptNumber?schoolCode=${schoolCode}`
    );
...
const [classFeeData, setClassFeeData] = useState({});
  ...
  const fetchClassFee = async (cls, sec) => {
    try {
      ...
      const res = await axios.get(`https://cleezoclass.com:5000/api/feeDetailsByClassSection`, {
