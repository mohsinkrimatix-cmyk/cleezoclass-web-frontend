...
useEffect(() => {
  ...
  axios
    .get("https://cleezoclass.com:5000/api/student-fee-details", {
      params: {
        schoolCode,
        class: selectedClass,
  ...
  setInstallments(newInstallments);
   ...
   const handleSaveClassInstallments = async () => {
    try {
      ...
      const response = await fetch('https://cleezoclass.com:5000/api/installmentdetails', {
        method: 'POST',
        headers: {
...
const handleSubmit = async (event) => {
  ...
  incomeData = {
    ...
    try {
      const response = await axios.put('https://cleezoclass.com:5000/income', incomeData);
...
useEffect(() => {
  ...
  axios
    .get(
      `https://cleezoclass.com:5000/api/payment/${selectedStudentId}?schoolCode=${schoolCode}`
    )
    .then((paymentRes) => {
      ...
      return axios
        .get("https://cleezoclass.com:5000/api/student-transactions-dynamic", {
          params: {
            schoolCode,
            studentName: selectedName,
...
tuition_paid_this_transaction: feeTypesPaid.tuition || 0,    tuition_installment_id: tuitionInstallmentIdBeingPaid,
  ...
  try {
    ...
    const duplicateCheckResponse = await fetch(
      "https://cleezoclass.com:5000/api/check-duplicate-fee-payment",
      {
        method: "POST",
...
if (duplicateCheckData?.exists && !isInstallmentPayment) {
  ...
  return;
    ...
    const response = await fetch(
      "https://cleezoclass.com:5000/pay-fee-detailsincome",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(paymentData),
...
const saveEditedBill = async (e) => {
  if (e?.preventDefault) e.preventDefault();
    ...
    try {
      ...
      const response = await axios.post('https://cleezoclass.com:5000/api/bill/save', formData);
...
const fetchTotals = async () => {
  ...
  try {
    ...
    if (studentName) {
      ...
      res = await axios.get("https://cleezoclass.com:5000/api/admin/getStudentTotals", {
      ...
      res = await axios.post(
        "https://cleezoclass.com:5000/api/admin/getClassSectionFeeTotal",
...
const [classFeeData, setClassFeeData] = useState({});
  ...
  const fetchClassFee = async (cls, sec) => {
    try {
      ...
      const res = await axios.get(`https://cleezoclass.com:5000/feeStructure/${cls}`, {
...
useEffect(() => {
  ...
  Promise.all(
    students.map(async (student) => {
      ...
      try {
        const response = await axios.get(`https://cleezoclass.com:5000/api/payment/${studentId}`, {
          params: { schoolCode },
        });
...
const enrichedDisplayFeeRows = React.useMemo(() => {
  ...
  return displayFeeRows.map((row) => {
    ...
    const paid = Math.max(Number(row.paid || 0), studentPaid);
          ...
          const backendTotalPaid = Number(
              ...
              return (
                ...
                >
                  {student.photo?.data ? (
                    <img
                      src={`https://cleezoclass.com:5000${bufferToPathString(student.photo.data)}`}
                      alt={student.name}
          ...
          {selectedStudentId && (
            <div className="payment-student-info">
              {studentData?.photo?.data ? (
                <img
                  src={`https://cleezoclass.com:5000${bufferToPathString(studentData.photo.data)}`}
                  alt="student"
